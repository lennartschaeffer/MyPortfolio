...
import mypic from '../photos/homepage.jpg'
      ...
      <div className="card-body d-flex justify-content-center align-items-center">
        <div className="row ">
              ...
              <div className="container">
                ...
                >
                  <p className="lead text-md-center m-0 font-weight-normal">
                    ...
                    with a passion for{" "}
                    <span className="highlighted-text">Full-Stack Software Development</span>, as 
                    well as an interest in  <span className="highlighted-text">Cloud Technologies </span>
                    and <span className="highlighted-text">Generative AI</span>.
                    I enjoy exploring new technologies and utilizing my creativity to build impactful solutions.
                  </p>
                </motion.div>
              </div>
            </div>
          ...
          <motion.div
                ...
                >
            <img src={mypic} alt="my-picture" className="img-fluid rounded-lg " />
            </motion.div>
          </div>
        </div>
      </div>
